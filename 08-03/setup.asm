...
kernel_copy:
  ...
  ; copy user_program1 onto 0x300000
  mov esi, 0x70000
  mov edi, 0x300000
  mov cx, 512
user1_copy:
  ...
  ; copy user_program2 onto 0x301000
  mov esi, 0x70200
  mov edi, 0x301000
  mov cx, 512
user2_copy:
  ...
  ; copy user_program3 onto 0x302000
  mov esi, 0x70400
  mov edi, 0x302000
  mov cx, 512
user3_copy:
  ...
  ; copy user_program4 onto 0x303000
  mov esi, 0x70600
  mov edi, 0x303000
  mov cx, 512
user4_copy:
  ...
  ; copy user_program5 onto 0x304000
  mov esi, 0x70800
  mov edi, 0x304000
  mov cx, 512
user5_copy:
